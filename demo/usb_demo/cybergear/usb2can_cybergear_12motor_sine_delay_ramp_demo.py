...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="USB2CAN sine + delay + ramp demo for 12 Xiaomi CyberGear motors."
    )
    ...
    parser.add_argument("--motors1", default="1,2,3,10,11,12")
    ...
    try:
        ...
        print("Sine + delay + ramp mode running. Press Ctrl+C to stop.")

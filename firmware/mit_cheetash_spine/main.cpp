...
int spi_enabled = 0;
InterruptIn cs(PA_15);
DigitalIn estop(PD_0);
...
Bits:   |7......0  |7......0  |7......0  |7......0  |7......0  |7......0  |
        +----------+----------+----------+----------+----------+----------+
        |   id     |  p[15:8] |  p[7:0]  | v[11:4]  |v[3:0]|i[11:8]|i[7:0] |
        +----------+----------+----------+----------+----------+----------+
*/
...
void WriteAll(){
    ...
    can1.write(a1_can);
    //wait_us(20);
    //rtos::ThisThread::sleep_for(chrono::microseconds(10));
    can2.write(a2_can);
    //wait_us(20);
    //rtos::ThisThread::sleep_for(chrono::microseconds(10));
    can1.write(h1_can);
    ...
    can2.write(k2_can);
    //wait_us(20);
    //rtos::ThisThread::sleep_for(chrono::microseconds(20));
    //toggle = 0;
    }
...
void init_spi(void){
    SPISlave *spi = new SPISlave(PC_12, PC_11, PC_10, PA_15);
    spi->format(16, 0);
